...
describe("VaultNotes", function()
    ...
    describe("VaultNotes:values_map_with_key()", function()
        it("should return a map of values with key", function()
            ...
            local random_note = Notes():get_random() or error("No notes found")
    ...
    describe("VaultNotes:duplicates()", function()
        -- if duplicates('path") then it should return empty table
        assert.is_true(Notes():duplicates("path") == {})
    end)
    ...
    describe("VaultNotes:has_note()", function()
        it(
            ...
            function()
                ...
                assert.is_true(notes:has(key, query, match_opt, case_sensitive))
            end
        )
        it(
    ...
    describe("VaultNotes:with_key(<VaulNote.data[key]>)", function()
        it(
            ...
            function()
                local notes = Notes():filter("frontmatter")
                for _, note in pairs(notes.map) do
    ...
    describe("VaultNotes:filter()", function()
        it(
            ...
            function()
                local notes = Notes():filter("stem", "20", "startswith", false)
                for _, note in pairs(notes.map) do
    ...
    describe("VaultNotes:filter('slug',)", function()
        it(
            ...
            function()
                ...
                local notes_with_slugs = Notes():filter("slug", query, "startswith", false)
    ...
    describe("VaultNotes:filter('path',)", function()
        it(
            ...
            function()
                ...
                local notes_with_path = Notes():filter("path", query, "startswith", false)
    ...
    describe("VaultNotes:filter('relpath')", function()
        it("should return a `VaultNotesGroup` object with `string` that starts with", function()
            ...
            local notes_with_relpath = Notes():filter("relpath", query, "startswith", false)
    ...
    describe("VaultNotes:filter('basename',)", function()
        it(
            ...
            function()
                ...
                local notes_with_basename = Notes():filter("basename", query, "startswith", false)
    ...
    describe("VaultNotes:filter('stem')", function()
        it(
            ...
            function()
                ...
                local notes_with_stem = Notes():filter("stem", query, "startswith", false)
    ...
    describe("VaultNotes:filter('title')", function()
        it(
            ...
            function()
                ...
                local notes = Notes():filter("title", query, "startswith", false)
                for _, note in pairs(notes.map) do
                    local title = note.data.title
    ...
    describe("VaultNotes:filter('content')", function()
        it(
            ...
            function()
                ...
                local notes_with_content = Notes():filter("content", query, "startswith", false)
    ...
    describe("VaultNotes:filter('frontmatter')", function()
        it(
    ...
    describe("VaultNotes:filter('body')", function()
        it(
            ...
            function()
                ...
                local notes_with_body = Notes():filter("body", query, "startswith", false)
        ...
        it(
            ...
            function()
                for _, note in pairs(notes.map) do
                    ...
                    assert.is_true(
                        next(note.data.outlinks) ~= nil or next(note.data.inlinks) ~= nil
                    )
                end
            end
        )
        ...
        it(
            ...
            function()
                for _, note in pairs(notes.map) do
                    ...
                    assert.is_true(
                        next(note.data.outlinks) ~= nil and next(note.data.inlinks) ~= nil
                    )
                end
            end
        )
    ...
    describe("VaultNotes:with_outlinks_unresolved", function()
        it(
            "should return notes that do NOT have `VaultNote.data.outlinks` with `target`",
            function()
