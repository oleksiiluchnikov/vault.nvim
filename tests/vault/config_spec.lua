describe("vault.config", function()
    ...
    describe("get_defaults", function()
        ...
        it("should expose telescope picker prewarm defaults", function()
            local defaults = Config.get_defaults()
            assert.is_table(defaults.telescope)
            assert.is_table(defaults.telescope.prewarm)
            assert.is_true(defaults.telescope.prewarm.notes)
            assert.is_true(defaults.telescope.prewarm.properties)
            assert.is_true(defaults.telescope.prewarm.tags)
            assert.is_true(defaults.telescope.prewarm.dirs)
            assert.are.equal(2000, defaults.telescope.prewarm.delay_ms)
        end)
    end)
