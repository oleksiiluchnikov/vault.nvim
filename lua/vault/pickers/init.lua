--- @class vault.Pickers
--- @field notes fun(opts: table?, notes: vault.Notes?): nil
--- @field tags fun(opts: table?, tags: vault.Tags?): nil
--- @field notes_by fun(tag_prefix: string): nil
--- @field root_tags fun(root_tag_name: string): nil
--- @field dates fun(start_date: string?, end_date: string?): nil
--- @field wikilinks fun(): nil
--- @field inbox fun(): nil
--- @field tasks fun(): nil
--- @field move_note_to fun(opts: table?, note: vault.Note?): nil
--- @field open_cluster fun(opts: table?, path: string?, notes: vault.Notes?, depth: integer?): nil
--- @field live_grep fun(opts: table?, query: string[]): nil
--- @field properties fun(opts: table?, query: string[]): nil
-- TODO: Picker
