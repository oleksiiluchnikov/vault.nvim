--- @module "telescope"
--- Workflow facade for cross-noun picker and orchestration helpers.
---
--- Prefer noun-owned modules when a direct owner exists:
--- - `vault.notes.*`
--- - `vault.tags.*`
--- - `vault.taxonomy.*`
--- - `vault.tasks.*`
---
--- This module remains as a lightweight orchestration surface.
